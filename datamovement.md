...
What we learned: I learned how to do the process of creating the file myself, while occasionally referencing the workflow my partners created to ensure I did everything correctly. 
...
What I learned: I learned how to use the software and what settings were needed so that the machine could correctly print out the intended design.
